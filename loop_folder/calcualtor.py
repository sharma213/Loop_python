...
# root.geometry("360x380+500+20")
val=""
data=StringVar()

dispaly=Entry(root,textvariable=data,bd=29,justify="right",bg="green",font=("ariel",20))
...
btn_Clear=Button(root,text="ac",font=("ariel",20,"italic"),bd=12,height=2,width=7,command=btnClear)
